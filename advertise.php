...
<html>
    <head>
        ...
        <meta name="description" content="Your ads can appear through Infoob's advertising network or, and Google related advertising networks." />
    ...
    <body>  
        ...
        <header>
            <div class="row">
                <a href="http://infoob.com"><img src="images/infooblogo_big.png" width="140" height="47" alt="Infoob" /></a>
                        ...
                        <div class="advertisement" >
                            ...
                            <div class="ad-body">
                                <form>
                                    ...
                                    <div>
                                        <label>
                                            Advertisement Queries* [<a href="https://serps.com/tools/keywords" target="_blank" title="Click to open SERPs keyword suggestion tool.">SERPs</a>]
                                            <div>
                                        ...
                                        <div class="informative-tip">
                                            Triggering queries, make sure each query that you enter <strong>sperate using a comma. </strong> Max 100 queries. Max 500 characters.
                                            <br/>
                                            Eg: SEO, Social Media Marketing, Digital Advertising
                                            <br/>
                                            <br/>
                                            Use a keyword tool like SERPs (See above) to find better and suitable keywords for your purpose.
                                        </div>                                     
                                    </div> 
                                    <div>
                                        <label>
