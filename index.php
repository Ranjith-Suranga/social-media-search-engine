...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="http://infoob.com/images/favicon.png" >
        <link rel="stylesheet" type="text/css" href="http://infoob.com/css/styles.css">
        <title>Social Media Search Engine - Infoob</title>
    ...
    <body>
        ...
        <main>
            ...
            <div id="logo-holder">
                <img src="http://infoob.com/images/infooblogo_big.png" alt="Infoob" title="Infoob"/>
            </div>
            ...
            <script type="text/javascript">
                function executeQuery() {
                    ...
                    if (input.value === '') {
                        ...
                        document.title = "Social Media Search Engine - Infoob";
                    } else {
                        document.title = input.value + " - Infoob";
        ...
        <footer>
            <ul id="footer-nav">
                <li><a href="http://infoob.com/advertising/">Advertising</a></li>
                <li><a href="http://infoob.com/blog/">Blog</a></li>
                <li><a href="http://infoob.com/policies/privacy.php">Privacy</a></li>
                <li><a href="http://infoob.com/policies/terms-and-conditions.php">Terms</a></li>
                <li><a href="http://infoob.com/policies/aboutus.php">About</a></li>
            </ul>
            <span id="copyright">Copyright &copy; Infoob 2016</span>
        </footer>
        ...
        <script type="text/javascript">
            ...
            document.body.onload = function () {
                ...
                if ( hash.length > 0 ){
                	var regExp = /gsc\.q=[\w%20]+&/;
	            	if ( regExp.test(hash) ){
						toggleStatus(false);
	            		var result = regExp.exec(hash);
	            		var newUrl = (result[0].substring(6,result[0].length-1));
	            		// console.log(newUrl);
	            		newUrl = newUrl.replace(new RegExp("%20","g")," ");
	            		document.getElementById("cse-search-input-box-id").value = newUrl;
                        document.title = newUrl + " - Infoob";
	            	}
                }
